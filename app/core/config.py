...
# CATATAN: CORS diatur oleh ALLOWED_ORIGINS (lihat di atas, #15). Dulu sempat ada
# CORS_ALLOW_ORIGINS terpisah dari implementasi #15 paralel — sudah dikonsolidasi
# ke ALLOWED_ORIGINS supaya tak ada dua sumber kebenaran yang bisa menyimpang.
